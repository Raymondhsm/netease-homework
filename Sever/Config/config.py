...
COMMAND_RELOAD = 0x05
COMMAND_DEAD = 0x06
COMMAND_PICK_UP = 0x07
COMMAND_USE_PROP = 0x08
COMMAND_MAGIC_ARROW = 0x09
COMMAND_MAGIC_EXPLOSE = 0x0A

COMMAND_NPC_COMMON = 0x80
COMMAND_NPC_ATTACK = 0x81
COMMAND_NPC_RESET = 0x82
COMMAND_NPC_SHOOT = 0x83
COMMAND_NPC_DIZZY = 0x84
...
COMMAND_ATTEND_GAME = 0x050000
COMMAND_END_GAME = 0x060000
COMMAND_CHECK_LOGIN = 0x070000
COMMAND_PLAYER_QUIT = 0x080000
...
ENTITY_REWARD_MEDICINE = 0x05000000
ENTITY_REWARD_BULLET = 0x06000000
ENTITY_KNIFE_ENEMY = 0x08000000
ENTITY_GUN_ENEMY = 0x09000000